  ...
  return (
    ...
    >
      <div className="inline-block relative" style={{ scale: 0.55 }}>
        {msg && (
          <div className="shadow-xl w-[180px] h-auto max-h-[104px] text-center flex items-center justify-center absolute -top-4 left-[90%] bg-white px-6 py-2 scale-[1.65] rounded-lg before:w-0 before:h-0 before:absolute before:left-2 before:-bottom-1.5 before:border-l-[6px] before:border-l-transparent before:border-t-[8px] before:border-t-white before:border-r-[16px] before:border-r-transparent">
            {msg}
          </div>
        )}
